...
def user_input() -> str:
    '''
    Функция запрашивает ввод пользователя с клавиатуры
    '''
...
def load_metadata(filepath: str) -> dict:
    ...
    Функция загружает текущие метаданные из файла
    '''
...
def save_metadata(filepath: str, data: dict) -> None:
    '''
    filepath - путь до .json файла,
    data - текущие метаданные.
    Функция выгружает текущие метаданные из программы и записывает их
    в файл для метаданных
    '''
...
def save_table_data(table_name: str, data: dict) -> None:
    ...
    Функция принимает имя таблицы и загружаемые данные, и, если таблица
    существует (существует её файл), то загружает в него актуальные данные.
    '''
    clean_table_name = table_name.strip().lower()
